...
rem 630 完了通知
rem =====================================
set callbat=bat\630.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 633 完了通知
rem =====================================
set callbat=bat\633.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 636 完了通知
rem =====================================
set callbat=bat\636.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 639 完了通知
rem =====================================
set callbat=bat\639.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 642 完了通知
rem =====================================
set callbat=bat\642.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 645 完了通知
rem =====================================
set callbat=bat\645.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 648 完了通知
rem =====================================
set callbat=bat\648.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
