...
REM ===== HULFT REV MOVE =================
DEL /Q %~dp0\DATA\*
ROBOCOPY  D:\HULFTFILES\RCV\0069 %~dp0DATA /R:0 /E /NFL /NP /XD backup bkup RcvTemp /MOV >> %OUTFILE%
...
rem ===== No.069 変換 ======================
call %~dp0..\CNV\J026Converter.bat %~dp0data\ J069.txt 0069

rem ===== LOAD ======================
set callbat=bat\026.069_LOAD.bat
