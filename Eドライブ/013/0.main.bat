...
rem 631 完了通知
rem =====================================
set callbat=bat\631.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 634 完了通知
rem =====================================
set callbat=bat\634.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 637 完了通知
rem =====================================
set callbat=bat\637.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 640 完了通知
rem =====================================
set callbat=bat\640.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 643 完了通知
rem =====================================
set callbat=bat\643.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 646 完了通知
rem =====================================
set callbat=bat\646.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
...
rem 649 完了通知
rem =====================================
set callbat=bat\649.完了通知.EXP.bat
echo %callbat% >> %outfile%
call %~dp0%callbat%
if errorlevel 1 goto error
