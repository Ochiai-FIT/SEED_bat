...
rem =====================================
rem 177 店別定量特売ファイルワーク6(全店特売)TIR
rem =====================================
...
rem =====================================
rem 177 店別定量特売データワーク8 全店特売(pre)
rem =====================================
