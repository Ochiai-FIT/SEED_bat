...
SET OUTFILENAME=0182
SET EXPFILE=%~DP0../exp/%OUTFILENAME%
SET HULFTID=MDMUR027

REM ===== HULFT SEND DELETE ===============
SET HULFT=D:\HULFTFILES\SEND\%OUTFILENAME%
DEL /Q %HULFT%\*

SET MSG=%DATE% %TIME% →  EXPORT処理(店別生活応援_商品)
ECHO %MSG%
>> %OUTFILE% ECHO %MSG%
"%MYSQLPATH%mysql" %OPTION% -h %HOST% %DB_NAME% -u %USER_ID% -N <  %~dp0182.ZZQ105.EXP.sql >%EXPFILE% 2>>%OUTFILE% 
